...
class FaturaPdfGenerator:
    def gerar(self, fatura: Fatura, boleto: Boleto, pix_payload: str) -> bytes:
        ...
        ], colWidths=[90 * mm, 85 * mm], style=TableStyle([
            ("BACKGROUND", (0, 0), (-1, 0), colors.HexColor("#12304a")), ("TEXTCOLOR", (0, 0), (-1, 0), colors.white),
            ("GRID", (0, 0), (-1, -1), 0.5, colors.HexColor("#b7c6d1")), ("VALIGN", (0, 0), (-1, -1), "TOP"), ("PADDING", (0, 0), (-1, -1), 7),
        ])))
        story += [Spacer(1, 8 * mm), Paragraph("DETALHES DA COBRANÇA", styles["Heading3"])]
        story.append(Table([["Descrição", "Valor"], ["Plano de telefonia", "R$ 89,90"], ["Internet", "R$ 49,90"], ["Desconto promocional", "- R$ 9,90"], ["Total", f"R$ {fatura.valor.valor:.2f}"]], colWidths=[130 * mm, 45 * mm], style=TableStyle([
            ("BACKGROUND", (0, 0), (-1, 0), colors.HexColor("#dce8ef")), ("GRID", (0, 0), (-1, -1), 0.4, colors.grey), ("ALIGN", (1, 0), (-1, -1), "RIGHT"), ("FONTNAME", (0, -1), (-1, -1), "Helvetica-Bold"), ("PADDING", (0, 0), (-1, -1), 6),
        ])))
        story += [Spacer(1, 7 * mm), Paragraph("INFORMAÇÕES DE PAGAMENTO", styles["Heading3"]), Paragraph(f"Linha digitável: {boleto.linha_digitavel}", styles["Normal"])]
        ...
        qr_buffer.seek(0)
        story += [Paragraph("PIX Copia e Cola", styles["Normal"]), Image(qr_buffer, width=32 * mm, height=32 * mm), Paragraph("Documento demonstrativo. Não representa cobrança bancária registrada.", styles["Normal"])]
